  ...
  return (
    <>
      <div style={styles.card}>
        ...
        {position.stipend_per_student != null && position.stipend_per_student > 0 && (
          <p style={styles.stipend}>Stipend: ${Number(position.stipend_per_student).toFixed(2)}</p>
        )}
        {position.max_students != null && (
          <p style={styles.gpa}>Slots: {position.max_students}</p>
        )}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  stipend: { fontSize: '0.85rem', color: '#059669', fontWeight: 600 },
